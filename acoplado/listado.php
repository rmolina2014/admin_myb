   ...
   <div class="row">
    <div class="col-md-12">
     ...
     <hr>
      <!--div class="container"-->
      <div id="div_dinamico">
        <p><button class="btn btn-primary" id="agregar">Agregar Nuevo Acoplado</button> </p>
         <table id="listado" class="table table-striped table-bordered table-hover table-condensed" >
          <thead>
             <tr>
              ...
              <th>Vencimiento Rev. Tecnica</th>

              <th>Vencimiento Ruta</th>
          ...
          ?>
           ...
           <tr>
              ...
              <td><?php echo $item['vencseguro'];?></td>
              <td><?php echo$item['vencreviciontecnica'];?></td>
              <td><?php echo$item['vencruta'];?></td>
              <td>
