<?php
 ...
 <div class="container-fluid">
   <div class="row">
    <div class="col-md-12">
     <h3>Facturas Proveedor</h3>
     <hr>
      <!--div class="container"-->
      <div id="div_dinamico">
        <p>

          <a href="nuevo.php" class="btn btn-primary">Agregar Factura</a>
         ...
         <table id="listado" class="table table-striped table-bordered table-hover table-condensed" >
          ...
          ?>
           <tr>
              ...
              <td>
                   <a class="btn btn-primary btn-sm" href="buscar_remitos.php?factura_id=<?php echo $item['id'];?>" > Remitos</a>
