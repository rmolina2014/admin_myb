...
if( isset($_POST['idcliente']) && !empty($_POST['idcliente']) )
 {
  ...
  $todobien = $objecto->nuevo($valordeclarado,$tipocomprobante,$contrareembolso,$idcliente,$idproveedor,$numero,$fecha, $bultos,$descripcion,$estado,$fechaestado,$fechaingreso,$marca,$fechaMarca,$origen);



  if($todobien) {
  echo "<script language=Javascript> alert('Se Registro en la BD.') </script>";
...
?>
 ...
 <div class="col-md-8">
  ...
  <div class="col-md-8">
    ...
    <input name="descripcion"  class="form-control" type="text" tabindex="8"  />
