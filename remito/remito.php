...
class remito
{
    ...
    // 10/07/2020 se agrego peso y volumen
    public function lista()
    {
     //$sql="SELECT * FROM `remito` where estado <> 'Entregado' and marca <> 'Borrado' order by id DESC";
     $sql="SELECT * FROM `remito` where estado <> 'Entregado' and marca <> 'Borrado' and historico='NO' order by id DESC LIMIT 600";
   ...
   public function nuevo($valordeclarado,$tipocomprobante,$contrareembolso,$idcliente,$idproveedor,$numero,$fecha,
             $bultos,$peso,$volumen,$descripcion,$estado,$fechaestado,$fechaingreso,$marca,$fechaMarca,$origen)
   {
