...
// PDO connect *********
function connect() {
//ost=localhost;dbname=se2015', 'root','haciendaroot', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
...
$sql = "SELECT id,nombre,codigo,cuit FROM proveedoressurexpre WHERE nombre LIKE (:keyword) or cuit LIKE (:keyword) ORDER BY nombre ASC LIMIT 0, 10";
